...
def mainGame():
    ...
    while True:
        ...
        check_crash = isCollide(playerx, playery, upperPipes, lowerPipes) # This function will return true if the player is crashed
        if check_crash:
            return     
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird by ADITYA RAKSHIT AND BHAVYA')
